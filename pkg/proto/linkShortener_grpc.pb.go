...
type LinkShortenerClient interface {
	Create(ctx context.Context, in *LongLink, opts ...grpc.CallOption) (*ShortLink, error)
...
func (c *linkShortenerClient) Create(ctx context.Context, in *LongLink, opts ...grpc.CallOption) (*ShortLink, error) {
	out := new(ShortLink)
	err := c.cc.Invoke(ctx, "/linkShortener.linkShortener/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *linkShortenerClient) Get(ctx context.Context, in *ShortLink, opts ...grpc.CallOption) (*LongLink, error) {
	out := new(LongLink)
	err := c.cc.Invoke(ctx, "/linkShortener.linkShortener/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LinkShortenerServer interface {
	Create(context.Context, *LongLink) (*ShortLink, error)
...
func (UnimplementedLinkShortenerServer) Create(context.Context, *LongLink) (*ShortLink, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedLinkShortenerServer) Get(context.Context, *ShortLink) (*LongLink, error) {
...
func _LinkShortener_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/linkShortener.linkShortener/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LinkShortenerServer).Create(ctx, req.(*LongLink))
	}
...
func _LinkShortener_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/linkShortener.linkShortener/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LinkShortenerServer).Get(ctx, req.(*ShortLink))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LinkShortener_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "linkShortener.linkShortener",
